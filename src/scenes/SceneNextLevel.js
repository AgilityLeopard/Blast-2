...
export default class SceneNextLevel extends SceneGame
{
  ...
  create ()
  {
    ...
    this.drawTitle('Следующий уровень', centerX, centerY - 50)

    const scoreText = `Очков заработано: ${this.scoreOnLevel}`
    const styleTitle = {
      fontFamily,
      fontSize: 18,
      textAlign: 'center',
    ...
    this.add.btn(centerX, centerY + 80, 'Следующий уровень', () =>
      {
